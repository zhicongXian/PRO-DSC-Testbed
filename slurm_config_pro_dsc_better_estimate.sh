...
# train
python3 ./main_knn_enhanced_cont_exclude_identity_better_estimate.py --data=cifar10-mcr --experiment_name=cifa10_mcr_data_dependent_regularization --epo=5000 >> cifa10_mcr_data_dependent_regularization_out.txt
