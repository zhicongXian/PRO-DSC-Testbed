#!/usr/bin/env bash
#
#SBATCH --job-name=pro_dsc_optuna_cifar10
...
# train
python3 ./main_gamma_optuna_automl.py --data=cifar10  --experiment_name=cifar10_optuna_automl_new   >> cifar10_auto_gamma_out.txt
