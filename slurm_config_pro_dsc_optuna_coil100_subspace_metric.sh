...
# train
python3 ./main_subspace_gamma_optuna_automl_with_subspace_metric.py --data=coil100  --experiment_name=coil100_automl_subspace_metric   >> rerun_gamma_sweep_coil100_out.txt
