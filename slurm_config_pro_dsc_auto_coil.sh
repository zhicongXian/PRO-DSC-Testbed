...
# train
python3 ./main_subspace_auto_gamma_l1_rerun.py --data=coil100 --experiment_name=coil100_auto_gamma_seed42_with_l1norm --seeds=[42] --load_pretrain  >> coil100_pretrain_knn_out.txt
