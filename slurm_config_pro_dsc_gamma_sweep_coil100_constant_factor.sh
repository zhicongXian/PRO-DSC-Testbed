#!/usr/bin/env bash
#
#SBATCH --job-name=pro_dsc_constant_factor_sweep_coil100
#SBATCH --array=0-10
#SBATCH --output=logs_coil100_constant_factor_%A_%a.out
...
python3 ./main_subspace_auto_gamma_constant_factor_sweep.py --data=coil100 --start_constant_factor=$start_constant_factor \
 --end_constant_factor=$end_constant_factor --experiment_name="wandb_constant_sweep_coil100_from{$start_constant_factor}_to{$end_constant_factor}" --seed=0
