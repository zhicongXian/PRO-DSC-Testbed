...
import sys
import wandb
from main_auto_gamma_gradient_balancing_original_working import gamma_previous
...
logger = logging.getLogger("auto_gamma_pro_dsc_gradient_balancing_combined_with_hpo")
...
def objective( trial : optuna.trial.Trial):
    ...
    gamma = None
    gamma_previous = None
    config['constant_factor'] = trial.suggest_float("lr", 0.25, 4)
...
if __name__ == '__main__':
    ...
    for seed in global_config['seeds']:
        ...
        study.optimize(objective, n_trials=5, timeout=3600*24) # time out after one day callbacks=[wandbc]
